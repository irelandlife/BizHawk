...
namespace BizHawk.API.ApiHawk
{
	...
	/// Changes from 2.4.2:
	/// <list type="bullet">
	/// <item><description>method <c>string GetBoardName()</c> replaced with property <see cref="BoardName"/></description></item>
	...
	{
		/// <remarks>TODO move to <see cref="IGameInfoLib"/></remarks>
